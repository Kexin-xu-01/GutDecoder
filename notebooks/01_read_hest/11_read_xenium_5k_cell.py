...
def main():
    ...
    for _, row in sample_rows.iterrows():
        ...
        base_out_dir = Path("/project/simmons_hts/kxu/hest/xenium_data") / f"Xenium{run_name}_cell" / f"slide{slide_num}"
        ...
        # --- Load Xenium dataset (optionally uses Dask inside the loader) ---
        # load_xenium_dataset is expected to return an object with:
        ...
        st = load_xenium_dataset(exp_stem, img_path, alignment_file, use_dask=True)

        # --- Load labelled single-cell data (h5ad produced elsewhere) ---
        h5ad_path = f"/project/simmons_hts/kxu/hest/xenium_labelled/h5ad/{sample}.h5ad"
